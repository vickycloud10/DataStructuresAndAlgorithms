 ...
 * 
 * Note : 
 * We are adding "+1" for results as it is a "1-indexed array".
 * 
 */
...
public class TwoSumII {
    ...
    public static int[] twoSum(int[] numbers, int target) {
        ...
        for(int i = 0; i < numbers.length; i++){
            ...
            if(processMap.containsKey(secondNumber)){
                ans[0] = processMap.get(secondNumber) + 1;
                ans[1] = i + 1; 
            } else {
                processMap.put(numbers[i], i);
            }
        }
        return ans;
    }
    ...
    public static void main(String[] args) {
        ...
        int resultOne [] = twoSum(numbers, target);
        int resultTwo [] = twoSumUsingTwoPointers(numbers, target);
